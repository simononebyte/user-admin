...
function removePermission($StartingDir, $UserOrGroup = "", $All = $false) {
...
function setInheritance($StartingDir, $DisableInheritance = $false, $KeepInheritedAcl = $false) {
...
function setPermission($StartingDir, $UserOrGroup = "", $InheritedFolderPermissions = "ContainerInherit, ObjectInherit", $AccessControlType = "Allow", $PropagationFlags = "None", $AclRightsToAssign) {
